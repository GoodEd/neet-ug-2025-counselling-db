...
result = subprocess.run(['pdftotext', '-layout', 'Jharkhand_NEET_6960bee4e1acda925837cf2bf1acef5a.pdf', '-'],
                       capture_output=True, text=True)
text = result.stdout

# Extract DOBs: match full date string without groups
...
print(f'=== JHARKHAND NEET 2024 AGE ANALYSIS ===')
